# Script PowerShell pour inspecter la base de données sessions.db
# Usage: .\inspect_sessions_db.ps1 [container_name]

param(
    [string]$ContainerName = "sfd-clm-backend-mcp"
)
...
$scriptPath = Join-Path $PSScriptRoot "inspect_sessions_db.py"
